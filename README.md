...
Приклад роботи:
Для прикладу оберемо рік мого народження - 2004, та місце мого проживання - м. Тернопіль, проспект Злуки, 8 (координати - (49.56067, 25.61824)). Датасетом скористаємось стандартним, тим, який нам надано в завданнi на CMS, під назвою locations.list. 
